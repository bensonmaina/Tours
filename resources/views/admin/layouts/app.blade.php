...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'The 2023 Tours'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; The 2023 Tours by <a href="https://www.bmtech.org" target="_blank">BMTech Team</a>
                    </div>
                    <div class="col-md-6">
