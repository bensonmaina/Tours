        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        <?php if(!empty($rows)): ?>
                            <form method="post" action="<?php echo e(url('admin/module/tour/category/editBulk')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
                    ...
                    <div class="col-left">
                        <form method="get" action="<?php echo e(url('/admin/module/tour/category')); ?> " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            ...
                            <table class="table table-hover">
                                ...
                                <?php if( count($rows) > 0): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="title">
                                            <a href="<?php echo e(url('admin/module/tour/category/edit/'.$row->id)); ?>"><?php echo e($prefix.' '.$row->name); ?></a>
                                        </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\thema\Downloads\Booking-System-Online-Laravel-Source-Code\booking\modules/Tour/Views/admin/category/index.blade.php ENDPATH**/ ?>