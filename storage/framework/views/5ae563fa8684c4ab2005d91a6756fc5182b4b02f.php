    ...
    <div class="container-fluid">
        ...
        <div class="text-right">
            <div class="header-status-control">
                ...
                <a href="<?php echo e(url("/admin/module/review?status=spam")); ?>"><?php echo e(__("Trash")); ?>
                        ...
                        <?php if($rows->total() > 0): ?>
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="<?php echo e($row->status); ?>">
                                    ...
                                    <td>
                                        <?php echo e($row->getAuthor->name ?? 'Author'); ?>

                                        <a href="<?php echo e(url("/admin/module/review?customer_id=".$row->getAuthor->id)); ?>"><?php echo e($row->getAuthor->email ?? 'Email'); ?></a>
                                        <p>
                                    ...
                                    <td>
                                        <?php if(!empty($service)): ?>
                                            <a href="<?php echo e(url("/admin/module/review?service_id=".$service->id)); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\thema\Downloads\Booking-System-Online-Laravel-Source-Code\booking\modules/Review/Views/admin/index.blade.php ENDPATH**/ ?>