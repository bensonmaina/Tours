<?php if(!empty($seo_meta)): ?>
    ...
    <?php endif; ?>
    <title><?php echo e($seo_meta['seo_title'] ?? $seo_meta['service_title'] ?? $page_title ?? ""); ?> - <?php echo e(setting_item('site_title' ,'The 2023 Tours')); ?></title>
...
<?php else: ?>
    <title><?php echo e($page_title ?? ''); ?> <?php echo e(setting_item('site_title' ,'The 2023 Tours')); ?></title>
    <meta name="description" content="<?php echo e(setting_item("site_desc")); ?>"/>
<?php endif; ?>
<?php /**PATH C:\Users\thema\Downloads\Booking-System-Online-Laravel-Source-Code\booking\resources\views/layouts/parts/seo-meta.blade.php ENDPATH**/ ?>