...
<head>
    ...
    <title><?php echo e($page_title ?? 'Dashboard'); ?> - <?php echo e(setting_item('site_title') ?? 'The 2023 Tours'); ?></title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; The 2023 Tours by <a href="https://www.bmtech.org" target="_blank">BMTech Team</a>
                    </div>
                    <div class="col-md-6">
...
<?php /**PATH C:\Users\thema\Downloads\Booking-System-Online-Laravel-Source-Code\booking\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>