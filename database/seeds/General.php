    ...
    public function run()
    {
        ...
        DB::table('core_settings')->insert(
            [
                ...
                [
                    ...
                    'val' => 'Copyright © 2019 by The 2023 Tours',
                    'group' => "general",
                ],
                [
        ...
        DB::table('core_settings')->insert(
            [
                [
                    'name' => "email_header",
                    'val' => '<h1 class="site-title" style="text-align: center">The 2023 Tours</h1>',
                    'group' => "general",
                ],
                [
                    'name' => "email_footer",
                    'val' => '<p class="" style="text-align: center">&copy; 2019 The 2023 Tours. All rights reserved</p>',
                    'group' => "general",
                ],
            ]
        );
