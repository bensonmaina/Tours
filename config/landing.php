...
return [
    ...
    'list_demo'=>[
        [
            'url'=>'https://www.The2023Tours.org',
            'name'=>'Homepage',
            'thumb'=>'img/demo/home.png',
        ],
        [
            'url'=>'https://www.The2023Tours.org/tour',
            'name'=>'Tour Search',
            'thumb'=>'img/demo/tour.png'
        ],
        [
            'url'=>'https://www.The2023Tours.org/tour/paris-vacation-travel',
            'name'=>'Single Tour',
            'thumb'=>'img/demo/tour_single.png'
        ],
        [
            'url'=>'https://www.The2023Tours.org/tour?_layout=map',
            'name'=>'Search Map',
            'thumb'=>'img/demo/tour_map.png',
            'class'=>'col-lg-8 col-md-12 col-sm-12'
        ],
        [
            'url'=>'https://www.The2023Tours.org/news',
            'name'=>'Blog List',
            'thumb'=>'img/demo/news.png'
        ],
//        [
//            'url'=>'https://www.The2023Toursss.org/contact',
//            'name'=>'Contact Page',
